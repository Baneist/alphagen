...
data_train = StockData(instruments, '2010-01-01', '2017-12-31', device=device)
data_valid = StockData(instruments, '2018-01-01', '2018-12-31', device=device)
data_test = StockData(instruments, '2019-01-01', '2020-01-01', device=device)
